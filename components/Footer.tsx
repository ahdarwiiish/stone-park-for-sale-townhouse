          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#details" className="hover:text-amber-500 transition-colors">Details</a></li>
                <li><a href="#financials" className="hover:text-amber-500 transition-colors">Financials</a></li>
                <li><a href="#gallery" className="hover:text-amber-500 transition-colors">Gallery</a></li>
              </ul>
            </div>
            <div>
               <h4 className="text-white font-bold mb-4">Address & Legal</h4>
               <p className="text-sm mb-4">
                 Stone Park Compound,<br />
                 Ring Road, New Cairo,<br />
                 Cairo, Egypt
               </p>
               <div className="flex space-x-4 text-sm">
                 <button onClick={() => setActiveModal('privacy')} className="hover:text-white underline">Privacy Policy</button>
                 <button onClick={() => setActiveModal('terms')} className="hover:text-white underline">Terms & Conditions</button>
               </div>
            </div>
          </div>
